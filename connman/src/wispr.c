...
#if defined TIZEN_EXT
gboolean __connman_wispr_is_service_starting(struct connman_service *service, int index)
{
...
#if defined TIZEN_EXT
	if (__connman_wispr_is_service_starting(service, index) == FALSE)
		return;
#endif
