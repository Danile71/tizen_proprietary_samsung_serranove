                 ...
                 void *event_info EINA_UNUSED)
{
   ...
   traceBegin(TTRACE_TAG_VIEW, "_index_resize_cb: %p", obj);
...
elm_index_add(Evas_Object *parent)
{
   ...
   traceBegin(TTRACE_TAG_VIEW, "elm_index_add: %p", parent);
...
_elm_index_level_go(Eo *obj, Elm_Index_Data *sd, int level)
{
   ...
   traceBegin(TTRACE_TAG_VIEW, "_elm_index_level_go: obj(%p) level(%d)", obj, level);
