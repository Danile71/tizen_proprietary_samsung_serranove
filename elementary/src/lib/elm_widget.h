...
typedef int (*Elm_Widget_Input_History_Dump_Cb)(char *dump_path);

// TIZEN ONLY: This is for UI Analyzer information.
EAPI char *elm_widget_description_get(const Evas_Object *obj);
EAPI void elm_widget_input_history_dump_callback_set(Elm_Widget_Input_History_Dump_Cb func);
EAPI Elm_Widget_Input_History_Dump_Cb elm_widget_input_history_dump_callback_get(void);
