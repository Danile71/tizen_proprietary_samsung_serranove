...
struct _Elm_Entry_Data
{
   ...
   Evas_Object                          *client_msg_handler;
   ...
   Eina_Bool                             drag_enabled : 1; // TIZEN ONLY
   Eina_Bool                             drop_enabled : 1; // TIZEN ONLY
   Eina_Bool                             cursor_handler_enabled : 1; // TIZEN ONLY
   Eina_Bool                             drop_added : 1; // TIZEN ONLY
   Eina_Bool                             selection_allow : 1; // TIZEN ONLY
   Eina_Bool                             magnifier_enabled : 1; // TIZEN ONLY
   Eina_Bool                             quick_memo_enabled : 1; // TIZEN ONLY
   Eina_Bool                             anchor_ctx_enabled : 1; // TIZEN ONLY
