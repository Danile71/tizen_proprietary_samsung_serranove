...
gst_uri_downloader_set_uri (GstUriDownloader * downloader, const gchar * uri,
    const gchar * referer, gchar* user_agent, gchar** cookies, gboolean compress, gboolean refresh,
...
gst_uri_downloader_fetch_uri (GstUriDownloader * downloader,
    const gchar * uri, const gchar * referer, gchar* user_agent, gchar** cookies, gboolean compress,
...
gst_uri_downloader_fetch_uri_with_range (GstUriDownloader *
    downloader, const gchar * uri, const gchar * referer, gchar* user_agent, gchar** cookies, gboolean compress,
...
#ifdef GST_ADAPTIVE_MODIFICATION
  if (!gst_uri_downloader_set_uri (downloader, uri, referer, user_agent, cookies, compress, refresh,
          allow_cache)) {
