...
#ifndef GST_EXT_RIFFMEDIA_MODIFICATION
    case GST_MAKE_FOURCC (0x00, 0x00, 0x00, 0x00): /* Kept in macro, so that FOURCC 0000 doesn't get detect as RGB format. Also no standard for FOURCC 0000 */
#endif
