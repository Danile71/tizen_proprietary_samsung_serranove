...
// Fix  Valgrind crash with volume element.
#define APPLY_VALGRIND_SIGILL_PATCH

#ifdef APPLY_VALGRIND_SIGILL_PATCH

#define VOLUME_UNITY_INT8_F            8.0  /* internal int for unity 2^(8-5) */
#define VOLUME_UNITY_INT16_F           2048.0       /* internal int for unity 2^(16-5) */
#define VOLUME_UNITY_INT24_F           524288.0     /* internal int for unity 2^(24-5) */
#define VOLUME_UNITY_INT32_F           134217728.0  /* internal int for unity 2^(32-5) */
...
#ifdef APPLY_VALGRIND_SIGILL_PATCH
    self->current_vol_i8 = volume * VOLUME_UNITY_INT8_F;
    self->current_vol_i16 = volume * VOLUME_UNITY_INT16_F;
    self->current_vol_i24 = volume * VOLUME_UNITY_INT24_F;
    self->current_vol_i32 = volume * VOLUME_UNITY_INT32_F;
#else
