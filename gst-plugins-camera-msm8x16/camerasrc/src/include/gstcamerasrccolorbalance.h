...
#define GST_TYPE_CAMERASRC_COLOR_BALANCE_CHANNEL \
    (gst_camerasrc_color_balance_channel_get_type ())
#define GST_CAMERASRC_COLOR_BALANCE_CHANNEL(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST ((obj), GST_TYPE_CAMERASRC_COLOR_BALANCE_CHANNEL, \
        GstCameraSrcColorBalanceChannel))
#define GST_CAMERASRC_COLOR_BALANCE_CHANNEL_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST ((klass), GST_TYPE_CAMERASRC_COLOR_BALANCE_CHANNEL, \
        GstCameraSrcColorBalanceChannelClass))
#define GST_IS_CAMERASRC_COLOR_BALANCE_CHANNEL(obj) \
    (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GST_TYPE_CAMERASRC_COLOR_BALANCE_CHANNEL))
#define GST_IS_CAMERASRC_COLOR_BALANCE_CHANNEL_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_TYPE ((klass), GST_TYPE_CAMERASRC_COLOR_BALANCE_CHANNEL))
