 ...
 */
 ...
 #ifndef __GSTQCAMERASRC_ERRORS_H__
#define __GSTQCAMERASRC_ERRORS_H__
...
#define CAMERASRC_WAR_UNAVAILABLE_DEVICE    (CAMERASRC_WARING | CAMSRC_IN_DEVICE)
...
#define CAMERASRC_ERR_UNAVAILABLE_DEVICE    (CAMERASRC_ERROR | CAMSRC_IN_DEVICE)
