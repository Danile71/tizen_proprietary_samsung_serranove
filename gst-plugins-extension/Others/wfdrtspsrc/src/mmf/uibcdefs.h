...
typedef enum {
  UIBC_INPUT_TYPE_UNKNOWN = 0,
  UIBC_INPUT_TYPE_KEYBOARD,
  UIBC_INPUT_TYPE_MOUSE,
  UIBC_INPUT_TYPE_SINGLETOUCH,
  UIBC_INPUT_TYPE_MULTITOUCH,
  UIBC_INPUT_TYPE_JOYSTICK,
  UIBC_INPUT_TYPE_CAMERA,
  UIBC_INPUT_TYPE_GESTURE,
  UIBC_INPUT_TYPE_REMOTECONTROL
}WFDUIBCHIDCInputTypeID;
...
typedef struct {
  ...
  WFDUIBCHIDCInputTypeID input_type_ID;
  guint32 length;
  gboolean is_report_descriptor;
  guint8 *report;
