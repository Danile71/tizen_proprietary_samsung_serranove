...
BuildRequires:  audio-echo-cancel-meta
%ifarch %{arm}
...
%define conf_option --disable-static --enable-alsa --disable-ipv6 --enable-tests --disable-oss-output --disable-oss-wrapper --enable-dlog --enable-bluez5 --disable-bluez4 --disable-hal-compat --with-udev-rules-dir=/usr/lib/udev/rules.d --without-speex --disable-systemd --disable-esd-compat --disable-pasuspender --disable-esound --disable-glib2 --disable-openssl --disable-ladspa --disable-rygel --disable-position-event-sound
...
%install
%make_install
#cp -f src/.libs/*test* %{buildroot}/usr/bin
