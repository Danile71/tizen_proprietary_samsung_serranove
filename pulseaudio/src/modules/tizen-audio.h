...
typedef enum audio_return {
    ...
    AUDIO_RET_NO_CHANGES                = (int32_t)0x40001001,
...
typedef enum audio_route_flag {
    ...
    AUDIO_ROUTE_FLAG_DUAL_LAST_OUT      = 0x00000004,
    ...
    AUDIO_ROUTE_FLAG_NETWORK_UPLINK    = 0x01000000,
    AUDIO_ROUTE_FLAG_NETWORK_DOWNLINK    = 0x02000000
} audio_route_flag_t;
...
typedef struct audio_interface {
    ...
    audio_return_t (*get_route)(void *userdata, uint32_t *session, uint32_t *subsession, uint32_t *device_in, uint32_t *device_out, uint32_t *route_flag);
    ...
    audio_return_t (*set_mixer_value)(void *userdata, const char* ctl, int value);
    audio_return_t (*set_mixer_value_string)(void *userdata, const char* ctl, const char* value);
    audio_return_t (*set_route_info)(void *userdata, const char* key, const char* value, void* additional_info);
    ...
    audio_return_t (*get_board_config)(void *userdata, board_config_t **board_config);
} audio_interface_t;
...
audio_return_t audio_get_route(void *userdata, uint32_t *session, uint32_t *subsession, uint32_t *device_in, uint32_t *device_out, uint32_t *route_flag);
audio_return_t audio_set_mixer_value(void *userdata, const char* ctl, int value);
audio_return_t audio_set_mixer_value_string(void *userdata, const char* ctl, const char* value);
audio_return_t audio_set_route_info(void *userdata, const char* key, const char* value, void* additional_info);
audio_return_t audio_get_board_config(void *userdata, board_config_t **board_config);
