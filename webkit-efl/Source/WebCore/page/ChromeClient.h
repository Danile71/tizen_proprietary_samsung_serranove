...
namespace WebCore {
    ...
    public:
        ...
        virtual void highlightNode(Node*) = 0;
        virtual void clearHighlightedNode(Node*) = 0;
#endif
        ...
        virtual void setActivePopUpMenuToNull() { }
#endif

#if ENABLE(CUSTOM_SCHEME_HANDLER) || !ENABLE(TIZEN_REGISTER_SCHEME_HANDLER)
        ...
        virtual void addSearchProvider(const String& baseURL, const String& engineURL) = 0;
        virtual unsigned long isSearchProviderInstalled(const String& baseURL, const String& engineURL) = 0;
#endif
        ...
        virtual void addOrUpdateScrollingLayer(Node*, GraphicsLayer* scrollingLayer, GraphicsLayer* contentsLayer, const IntSize& scrollSize) = 0;
        virtual void removeScrollingLayer(Node*, GraphicsLayer* scrollingLayer, GraphicsLayer* contentsLayer) = 0;
#endif
        ...
        virtual bool getStandaloneStatus() { return true; }
#endif

#if ENABLE(SCREEN_ORIENTATION_SUPPORT)
        virtual bool lockOrientation(int willLockOrientation) { return false; }
        ...
        virtual void requestVisibleContentRectRestore(const IntPoint& scrollOffset, float scale) = 0;
        virtual float contentsScaleFactor() const = 0;
#endif

#if ENABLE(TIZEN_POPUP_BLOCKED_NOTIFICATION)
        virtual void popupBlocked(const String&) { }
#endif
        ...
        virtual void mediaControlsRequestRotate(const String&) = 0;
#if ENABLE(APP_LOGGING_FOR_MEDIA)
        virtual void videoStreamingCount() = 0;
#endif
        virtual void setGrabMediaKey(bool grab) { }
#endif
    ...
    virtual void updateScrollbarModes(Frame*) { }
#endif
