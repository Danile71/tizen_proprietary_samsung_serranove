...
public:
    ...
    virtual void updateScrollbars(const IntSize& desiredOffset);
#endif
    ...
    virtual void setFixedVisibleContentRect(const IntRect&, bool allowFixedElementUpdate = true) OVERRIDE;
#else
    ...
    virtual void requestVisibleContentRectRestore(const IntPoint& position, float scale);
#endif
