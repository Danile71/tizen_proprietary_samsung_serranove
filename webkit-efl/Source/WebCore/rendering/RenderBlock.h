...
protected:
    ...
    public:
        ...
        FloatIntervalSearchAdapter(const RenderBlock* renderer, LayoutUnit lowValue, LayoutUnit highValue, LayoutUnit& offset, LayoutUnit* heightRemaining)
            : m_renderer(renderer)
            , m_lowValue(lowValue)
        ...
        inline LayoutUnit lowValue() const { return m_lowValue; }
        inline LayoutUnit highValue() const { return m_highValue; }
        void collectIfNeeded(const IntervalType&) const;

    private:
        const RenderBlock* m_renderer;
        LayoutUnit m_lowValue;
        LayoutUnit m_highValue;
        LayoutUnit& m_offset;
