...
public:
    ...
    float splitScrollOverflow(ScrollDirection, ScrollGranularity, float offset);
#endif
    void autoscroll();
...
#if ENABLE(TIZEN_CSS_OVERFLOW_SCROLL_ACCELERATION)
    GraphicsLayer* layerForScrollingContents() const;
#endif
    ...
    bool hasAcceleratedRotate() const { return m_hasAcceleratedRotate; }
#endif
    ...
    virtual void setNeedsSyncOverflowScrolling(bool) OVERRIDE;
#endif
...
#endif
#if ENABLE(TIZEN_ACCELERATED_ROTATE_TRANSFORM)
    bool m_hasAcceleratedRotate;
#endif
#if ENABLE(TIZEN_BROWSER_DASH_MODE) && ENABLE(TIZEN_ACCELERATED_ROTATE_TRANSFORM)
    int m_countUpdateTransform;
    bool m_isAccelerated;
    void transformDashModeFired(Timer<RenderLayer>*) { };
    void updateTransformFired(Timer<RenderLayer>*);
    Timer<RenderLayer> m_transformDashModeTimer;
    Timer<RenderLayer> m_updateTransformTimer;
#endif
