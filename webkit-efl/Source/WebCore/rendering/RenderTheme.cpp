...
bool RenderTheme::paint(RenderObject* o, const PaintInfo& paintInfo, const IntRect& r)
{
    ...
    switch (part) {
        ...
        case MediaDefatultImagePart:
            return paintMediaDefaultImage(o, paintInfo, r);
        case MediaOverlayLoadingSpinnerPart:
            return paintMediaOverlayLoadingSpinner(o, paintInfo, r);
        case MediaRotateButtonPart:
            return paintMediaRotateButton(o, paintInfo, r);
        case MediaControlPanelBackGroundImageVerticalPart:
        case MediaControlPanelBackGroundImageHorizontalPart:
            return paintMediaControlPanelBackGroundImage(o, paintInfo, r);
#endif
        case MenulistButtonPart:
        case TextFieldPart:
        case TextAreaPart:
...
Color RenderTheme::activeSelectionBackgroundColor() const
{
    ...
    m_activeSelectionBackgroundColor = platformActiveSelectionBackgroundColor();
...
#if ENABLE(TIZEN_SELECTION_BACKGROUND_COLOR)
        m_inactiveSelectionBackgroundColor = platformInactiveSelectionBackgroundColor();
#else
                                  ...
                                  const Color& backgroundColor) const
{
    switch (style->appearance()) {
        ...
        case DiscreteCapacityLevelIndicatorPart:
        case RatingLevelIndicatorPart:
#if ENABLE(TIZEN_SEARCH_FIELD_STYLE)
        case SearchFieldPart:
#else
...
void RenderTheme::paintSliderTicks(RenderObject* o, const PaintInfo& paintInfo, const IntRect& rect)
{
    ...
    if (isHorizontal) {
        ...
        tickRegionWidth = rect.width() - tickRegionMargin * 2 - tickSize.width() * zoomFactor - thumbSize.width();
    } else {
        ...
        tickRegionWidth = rect.height() - tickRegionMargin * 2 - tickSize.width() * zoomFactor - thumbSize.width();
    }
