...
public:
    ...
    virtual String extraFullScreenHorizontalStyleSheet() { return String(); };
    virtual String extraFullScreenVerticalStyleSheet() { return String(); };
#else
...
protected:
    ...
    virtual bool paintMediaDefaultImage(RenderObject*, const PaintInfo&, const IntRect&) { return true; }
    virtual bool paintMediaOverlayLoadingSpinner(RenderObject*, const PaintInfo&, const IntRect&) { return true; }
    virtual bool paintMediaRotateButton(RenderObject*, const PaintInfo&, const IntRect&) { return true; }
    virtual bool paintMediaControlPanelBackGroundImage(RenderObject*, const PaintInfo&, const IntRect&) { return true; }
#endif
