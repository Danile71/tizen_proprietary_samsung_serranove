...
#if ENABLE(TIZEN_ROOT_INLINE_BOX_SELECTION_TOP)
        /* To avoid too high highlight on bbc.co.uk
         * This issue is reported on bugzilla:
         * https://bugs.webkit.org/show_bug.cgi?id=65307
         * You can find there simple pages to test it.
         */
